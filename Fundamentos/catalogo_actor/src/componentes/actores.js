...
import { ValidationMessage, ErrorMessage, Esperando, PaginacionCmd as Paginacion, PaginacionCmd } from "../biblioteca/comunes";
...
export class ActoresMnt extends Component {
    ...
    constructor(props) {
        ...
        this.url = (process.env.REACT_APP_API_URL || 'http://localhost:8001/') + 'actores';
    }
...
function ActoresList(props) {
    return (
        <>
            ...
            <PaginacionCmd actual={props.pagina} total={props.paginas} onChange={num =>
